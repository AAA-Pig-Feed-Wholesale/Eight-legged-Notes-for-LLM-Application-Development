...
1. [先看懂：大模型“参数”到底该怎么看](#1-先看懂大模型参数到底该怎么看)
2. [2020—2026：模型代际演进脉络](#2-20202026模型代际演进脉络)
3. [国际主流平台：重点模型详细介绍](#3-国际主流平台重点模型详细介绍)
4. [国内主流平台：重点模型详细介绍](#4-国内主流平台重点模型详细介绍)
5. [应用开发相关的其他模型能力](#5-应用开发相关的其他模型能力)
6. [工程选型：如何在项目里真正选模型](#6-工程选型如何在项目里真正选模型)
7. [典型组合方案](#7-典型组合方案)
8. [高频误区](#8-高频误区)
9. [一页式总结](#9-一页式总结)
10. [官方参考链接](#10-官方参考链接)
